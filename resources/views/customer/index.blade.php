                        ...
                        <tbody>
                            @forelse($customers as $customer)
                                <tr>
                                    <td>{{ $customer->id }}</td>
                                    <td>
                                        {{-- Nom cliquable vers la fiche --}}
                                        <a href="{{ route('customer.show', $customer->id) }}" class="text-decoration-none fw-bold text-dark">
                                            {{ $customer->full_name }}
                                        </a>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group btn-group-sm">
                                            {{-- Lien œil vers la fiche client --}}
                                            <a href="{{ route('customer.show', $customer->id) }}" class="btn btn-light" title="Voir les achats">
                                                <i class="bi bi-eye"></i>
                                            </a>
