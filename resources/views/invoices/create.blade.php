                ...
                <form action="{{ route('invoices.store') }}" method="POST" id="invoice-form">
                    ...
                    <div class="row g-3 mb-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" name="invoiced_at" value="{{ old('invoiced_at', now()->format('Y-m-d')) }}"
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="text" name="reference" value="{{ old('reference') }}"
                                class="form-control @error('reference') is-invalid @enderror" placeholder="Ex: INV-2025-001"
                                required>
