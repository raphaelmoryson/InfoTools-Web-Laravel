    ...
    <div class="navbar">
        ...
        <div class="navbar_link">
            <ul class="nav flex-column">
                ...
                @auth
                    <li class="nav-item">
                        <a href="{{ url('/') }}" class="nav-link d-flex align-items-center {{ request()->is('/') ? 'active' : '' }}">
                            <i class="bi bi-speedometer2 me-2"></i> Tableau de bord
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('customer.index') }}" class="nav-link d-flex align-items-center {{ request()->is('clients*') ? 'active' : '' }}">
                            <i class="bi bi-people me-2"></i> Clients
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('appointments.index') }}" class="nav-link d-flex align-items-center {{ request()->is('appointments*') ? 'active' : '' }}">
                            <i class="bi bi-calendar-check me-2"></i> Rendez-vous
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('products.index') }}" class="nav-link d-flex align-items-center {{ request()->is('products*') ? 'active' : '' }}">
                            <i class="bi bi-box-seam me-2"></i> Produits
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('invoices.index') }}" class="nav-link d-flex align-items-center {{ request()->is('invoices*') ? 'active' : '' }}">
